...
function App() {
  ...
  return (
    <div className="flex flex-col h-screen bg-slate-50 font-sans text-slate-800 selection:bg-yellow-500 selection:text-slate-900">
      ...
      {/* Premium Header */}
      <header className="bg-white border-b border-slate-200 px-4 md:px-6 py-3 md:py-4 flex justify-between items-center z-10 sticky top-0 shadow-sm">
        <div className="flex items-center gap-4 md:gap-6">
          <h1 className="text-xl md:text-2xl font-black tracking-tight text-slate-900">
            OpenLiveLink<span className="text-yellow-500">.</span>
          </h1>
          <nav className="hidden md:flex gap-6 text-sm font-medium text-slate-500">
            <a href="#" className="bg-yellow-500 text-white px-4 py-1.5 rounded-full shadow-md shadow-yellow-500/20">FLEET</a>
          </nav>
        </div>
        <div className="flex items-center gap-2 md:gap-3">
          <div className="w-2 h-2 rounded-full bg-green-500 animate-pulse shadow-[0_0_8px_rgba(34,197,94,0.6)]"></div>
          <span className="text-xs md:text-sm font-semibold text-slate-600 hidden sm:block">Dashboard</span>
        </div>
      </header>
